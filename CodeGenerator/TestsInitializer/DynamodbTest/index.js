...
if (((_a = model === null || model === void 0 ? void 0 : model.api) === null || _a === void 0 ? void 0 : _a.database) === cloud_api_constants_1.DATABASE.dynamo) {
    templating_1.Generator.generate({
        outputFile: `${cloud_api_constants_1.PATH.test}${USER_WORKING_DIRECTORY}-dynamodb.test.ts`,
    }, (output) => {
