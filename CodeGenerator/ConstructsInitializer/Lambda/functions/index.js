...
const lambdaHandlerForAuroradb = (output, lambdaStyle, dataBase) => {
    ...
    if ((apiType === cloud_api_constants_1.APITYPE.graphql && lambdaStyle === cloud_api_constants_1.LAMBDASTYLE.single) ||
        apiType === cloud_api_constants_1.APITYPE.rest) {
    ...
    else if (apiType === cloud_api_constants_1.APITYPE.graphql && lambdaStyle === cloud_api_constants_1.LAMBDASTYLE.multi) {
        if (database === cloud_api_constants_1.DATABASE.aurora) {
...
const lambdaProperiesHandlerForAuroraDb = (output) => {
    ...
    if (((lambdaStyle === cloud_api_constants_1.LAMBDASTYLE.single && apiType === cloud_api_constants_1.APITYPE.graphql) ||
        apiType === cloud_api_constants_1.APITYPE.rest) &&
        database === cloud_api_constants_1.DATABASE.aurora) {
        properties = [
            {
                name: `${apiName}_lambdaFnArn`,
                typeName: "string",
        ...
        apiType === cloud_api_constants_1.APITYPE.graphql &&
        database === cloud_api_constants_1.DATABASE.aurora) {
...
const lambdaProperiesHandlerForNeptuneDb = (output) => {
    ...
    if (((lambdaStyle === cloud_api_constants_1.LAMBDASTYLE.single && apiType === cloud_api_constants_1.APITYPE.graphql) ||
        apiType === cloud_api_constants_1.APITYPE.rest) &&
        database === cloud_api_constants_1.DATABASE.neptune) {
        properties = [
            {
                name: `${apiName}_lambdaFnArn`,
                typeName: "string",
